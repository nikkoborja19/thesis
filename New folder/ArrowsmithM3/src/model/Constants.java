...
public class Constants {
    ...
    public static final String FACULTY_YEARSOFSERVICE = "years_of_service";
    ...
    public static final String DAYS_ROOM = "room";
    ...
    public static final String LOADS_HASRESEARCHLOAD = "hasResearchLoad";
    public static final String LOADS_ISADMIN = "isAdmin";
    public static final String LOADS_LEAVETYPE = "leave_type";
    public static final String LOADS_ISONLEAVE = "isOnLeave";
    ...
    public static final String OFFERING_ISNONACAD = "isNonAcad";
    public static final String OFFERING_ISSHS = "isSHS";
    public static final String OFFERING_ISSERVICECOURSE = "isServiceCourse";
    public static final String OFFERING_SERVICEDEPTID = "servicedept_id";
    public static final String OFFERING_ISMASTERS = "isMasters";
    public static final String OFFERING_ISELECTIVE = "isElective";
