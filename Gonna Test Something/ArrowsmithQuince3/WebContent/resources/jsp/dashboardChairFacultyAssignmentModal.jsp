<form id="">
    ...
    <label style="display:none" id="assignFacultyStartYearValue" value=""> </label>
    <label style="display:none" id="assignFacultyEndYearValue" value=""> </label>
    <label style="display:none" id="assignFacultyTermValue" value=""> </label>
