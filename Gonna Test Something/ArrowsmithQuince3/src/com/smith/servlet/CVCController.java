...
//			System.out.println(dept.getDeptCode());
	...
	public void insertNewFacultyIntoDB(@RequestParam Map<String, String> params) {
		College college = null;
		Department dept = null;
		User user = null;
		User temp = null;
...
/********************** DELOADING *************************************/
	...
	public @ResponseBody StringResponse leaveDeloading(
			@RequestParam("facultyId") String facultyId,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
			@RequestParam("term") String term,
	...
	public @ResponseBody StringResponse otherDeloading(
			@RequestParam("facultyId") String facultyId,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
			@RequestParam("term") String term,
	...
	public @ResponseBody StringResponse removeDeloadingFromFaculty(
	...
	public @ResponseBody StringResponse addNewDeloading(
