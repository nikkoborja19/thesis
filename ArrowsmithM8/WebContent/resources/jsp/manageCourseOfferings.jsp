                ...
                <table class="table" name = "table1">
                    ...
                    <tbody>
                    	<c:forEach items="${offeringList }" var="offering">
	                        <tr class="success">
	                            <td><a href="#"><c:out value="${offering.courseId }"/></a></td>
	                            <td><c:out value="${offering.section }"/></td>
	                            <td><c:out value="${offering.days[0].classDay }"/><c:out value="${offering.days[1].classDay }"/></td>
	                            <td><c:out value="${offering.beginTime }"/></td>
	                            <td><c:out value="${offering.endTime }"/></td>
	                            <td><c:out value="${offering.room }"/></td>
	                        </tr>
                        </c:forEach>
                    </tbody>
                </table>
