...
<head>
	    ...
	    <link href="resources/css/dashboardChairStyle.css" rel="stylesheet">
	     <link href="resources/css/FacultyListView.css" rel="stylesheet">
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<jsp:include page="dashboardChairSideBar.jsp"/>
			<jsp:include page="dashboardChairFacultyAssignmentPanel.jsp"/>
			<jsp:include page="dashboardAPOViewOfferingsPanel.jsp"/>
			<jsp:include page="dashboardCVCViewFacultyPanel.jsp"/>
			<jsp:include page="dashboardCVCViewFacultyInfoPanel.jsp"/>
			<jsp:include page="dashboardCVCViewCourses.jsp"/>
		</div>
	</div>
	<jsp:include page="footer.jsp"/>
	<!-- MODALS -->
		<jsp:include page="dashboardAPOViewRoomsModal.jsp"/>
		<jsp:include page="dashboardChairFacultyAssignmentModal.jsp"/>
		...
		<jsp:include page="dashboardCVCFacultyInfoAssignmentModal.jsp"/>
	<!-- MODALS -->
	
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script src="resources/javascript/bootstrap.min.js"></script>
  	<script src="resources/javascript/parallax.min.js"></script>
  	<script src="resources/javascript/dashboardChair.js"></script>
