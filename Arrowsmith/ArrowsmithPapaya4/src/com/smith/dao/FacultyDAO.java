...
//        System.out.println("PStatement: " + st);
  ...
  //Deloading 
    public static ArrayList<Faculty> getAllFacultyWithSearchKeyViaDeloading(Offering o, String facultyType, String deptId, String collegeId, String key, String startYear, String endYear, String term) throws SQLException{   
		ArrayList<Faculty> facultyList = new ArrayList<Faculty>();
        Connection con = Connector.getConnector();
        String newDeptID, newCollegeID;
    ...
    public static ArrayList<Faculty> getAllFacultyWithRecommendationsViaDeloading(Offering o, String facultyType, String deptId, String collegeId, String key, String startYear, String endYear, String term) throws SQLException{   
		ArrayList<Faculty> facultyList = new ArrayList<Faculty>();
        Connection con = Connector.getConnector();
        ...
        while(rs.next()){   
        	...
        	f = new Faculty(u, rs.getString(Constants.FACULTY_ID), rs.getString(Constants.FACULTY_YEARSTARTED), rs.getString(Constants.FACULTY_TYPE), "Recommended", rs.getString("faculty_count"));
        	System.out.println("facultyID in getLoad: " + f.getFacultyId());
        	f.setLoad(LoadDAO.getLoadByID(f.getFacultyId(), startYear, endYear, term));
        	//System.out.println("department: " + f.getDepartment().getDeptCode());
