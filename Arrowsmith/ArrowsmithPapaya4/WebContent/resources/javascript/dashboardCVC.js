        	...
        	$.each(data, function(i, currObject){
    			...
    			rows+=	"<td>"+classDay+"</td>"+
						...
						if(currObject.faculty.userId != "11111111"){
							...
							rows+="<td><a class=\"btn btn-default assign-button\" type=\"button\" onclick=\"checkIfFacultyAssignmentPossible(this.id)\" id=\""+offeringId+"-"+facultyId+"-facultyassign\"><span><i class=\"fa fa-plus-circle\"></i></span></a></td>"
						}
        ...
        success: function (data) {
        	...
        	$.each(data, function(i, currObject){
        		...
        		rows += "<tr id=\"" + facultyId + "-id\">";
					...
					rows += "<td>"+name+/*facultyId+clickedOfferingFA+*/"</td>";
...
function adminDeloading() {
	...
	if (deloadingId == 0) // none selected
		console.log("No admin deloading selected!");
	else {
...
function researchDeloading() {
	...
	if (deloadingId == 0) // none selected
		console.log("No research deloading selected!");
	else {
...
function getListFacultyLoadViaDeloading(id){
