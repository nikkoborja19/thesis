...
public class DegreeprogramDAO {
	...
	public static String getIDByCode(String code) throws SQLException {
        Connection con = Connector.getConnector();
        String query = "SELECT " + Constants.DEGREEPROGRAM_ID + " FROM " + Constants.DEGREEPROGRAM_TABLE + " WHERE " + Constants.DEGREEPROGRAM_CODE + " LIKE ?";
        ...
        return rs.getString(Constants.DEGREEPROGRAM_ID);
	}
}
