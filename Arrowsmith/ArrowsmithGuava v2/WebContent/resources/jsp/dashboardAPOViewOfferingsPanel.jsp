...
<div id="subcontainer">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
     <div class="row">
           <div class="col-md-4">
                <a class="btn btn-default" type="button" onclick="initializeAddNewOfferingsModal()" data-toggle="modal" data-target="#addNewOfferingsModal" data-backdrop="static" data-keyboard="false" id="addNewOfferingsButton"><span><i class="fa fa-calendar-plus-o"></i></span> Add New Offerings</a>
           </div>
      </div>  
      <br>
