	...
	$.ajax({
        ...
        success: function (data) {
        	...
        	$.each(data, function(i, currObject){
        		...
        		var lastName = currObject.user.lastName;
        		var firstName = currObject.user.firstName;
        		var name = firstName + " " + lastName;
        		var department = currObject.user.department.deptCode;
        		console.log(currObject.userId);
        		var college = currObject.user.college.collegeCode;
        		var facultyType = currObject.user.userType;
        		var currentLoad = "0";
