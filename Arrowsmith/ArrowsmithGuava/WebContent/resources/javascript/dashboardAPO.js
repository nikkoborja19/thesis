        ...
        success: function (data) {
        	...
        	$.each(data, function(i, currObject){
        		...
        		rows += "<tr id=\"" + id + "-id\" class=\"AYRow\">"+
        				...
        				"<td>"+term+"</td>"+
        				//data backdrop static prevents exit from background while data-keyboard false prevents exit using keyboard keys
        				"<td>" + "<a class=\"btn btn-default\" type=\"button\" onclick=\"updateRoomAssignmentModal(this.id)\" data-toggle=\"modal\" data-target=\"#roomAssignmentModal\" data-backdrop=\"static\" data-keyboard=\"false\" id=\"" + id + "-assignrooms\"><span><i class=\"fa fa-map-pin\"></i></span> Assign Rooms</a>" + "</td>"+  
        				"<tr>";
        	...
        	$.each(data, function(i, currObject){
        		...
        		rows += "<tr id=\"" + id + "-id\" class=\"AYRow\">"+
        				...
        				rows += "<td>" + "<a class=\"btn btn-default\" type=\"button\" onclick=\"viewOfferingsInModal(this.id)\" data-toggle=\"modal\" data-target=\"#viewOfferingsModal\" data-backdrop=\"static\" data-keyboard=\"false\" id=\"" + concatId + "-view\"><span><i class=\"fa fa-search\"></i></span></a> " +
        						"<a class=\"btn btn-default trash-button\" type=\"button\" onclick=\"confirmDeleteOffering(this.id)\" data-toggle=\"modal\" data-target=\"#dashboardAPOConfirmDeleteOfferingsModal\" data-backdrop=\"static\" data-keyboard=\"false\" id=\"" + concatId + "-view\"><span><i class=\"fa fa-trash\"></i></span></a>" + "</td>"+  
        				"<tr>";
...
function updateTemporaryOfferingList(){
	...
	$.each(tempCourseOfferings, function(i, currObject){
		...
		rows += "<tr id=\"" + id + "-id\" class=\"AYRow\">"+
				"<td class=\"editable-cell\" id=\""+id+"-degreeProgram\" contenteditable>"+degreeProgram+"</td>"+
				...
				rows += "<td><a class=\"btn btn-default trash-button\" type=\"button\" onclick=\"deleteCourseFromTemporaryOfferingTable(this.id)\" id=\"" + id + "-delete\"><span><i class=\"fa fa-trash\"></i></span></a></td></tr>"
...
function addNewOfferingsToDB(){
	...
	if(tempCourseOfferings.length != 0){
		...
		if(currOffering.daysList1.length === 0)currOffering.daysList1.push("ND"); //servlet wont read this kapag walang laman. filter nalang ung ND sa DAO
		if(currOffering.daysList2.length === 0)currOffering.daysList2.push("ND");
