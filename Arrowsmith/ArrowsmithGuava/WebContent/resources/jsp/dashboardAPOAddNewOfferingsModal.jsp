    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="addNewOfferingsModalTitle">Add New Offerings</h4>
      	...
      	<div class="col-md-12">
      	<br>
      	<div class ="row" id="divModalANOAYInfo">
	      ...
	      <div class="modal-body col-md-6" id="addNewOfferingsModalBody">
	      	<div class ="col-md-12">
		        <div class="col-md-3 form-group">
		          ...
		          <form id="termFormANO">
				    <label class="radio-inline"><input type="radio" checked name="optradio" id="radio1ANO">1</label>
				    <label class="radio-inline"><input type="radio" name="optradio" id="radio2ANO">2</label>
				    <label class="radio-inline"><input type="radio" name="optradio" id="radio3ANO">3</label>
				  </form>
	       		</div>
       		</div>
       		<div class ="col-md-12">
       		...
       		<div class="row" id="divModalANOFlowchartCourses">
	      ...
	      <div class="modal-body col-md-6" id="addNewOfferingsModalBody2">
	      	<div class ="col-md-12">
