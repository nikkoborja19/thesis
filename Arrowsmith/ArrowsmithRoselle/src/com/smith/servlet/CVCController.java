...
import com.smith.dao.DeloadingDAO;
...
import com.smith.dao.RequisiteDAO;
...
import com.smith.model.DeloadOffer;
import com.smith.model.Deloading;
import com.smith.model.Department;
import com.smith.model.Faculty;
import com.smith.model.Load;
import com.smith.model.LoadTimeblock;
...
import com.smith.utility.RandomString;
...
//		else  newFacultyType = "FT";
	...
	public @ResponseBody ArrayList<Faculty> getAllFacultyLoadWithFilters(
			@RequestParam("term") String term,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
	...
	public @ResponseBody ArrayList<LoadTimeblock> getAllFacultyLoadByTimeBlock(
			@RequestParam("term") String term,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
			@RequestParam("facultyId") String facultyId) {
	...
	public @ResponseBody ArrayList<Offering> getAllLoadsOfFaculty(
			@RequestParam("facultyId") String facultyId,
			@RequestParam("term") String term,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear) {
	...
	public @ResponseBody ArrayList<String> getAllCourseSuggestionByCollege(@RequestParam("userId") String userId) {
...
//			System.out.println(dept.getDeptCode());
	...
	public @ResponseBody Envelope insertNewCourseIntoDB(@RequestParam Map<String, String> params, 
		...
		try {
			...
			return new Envelope(course.getCourseCode() + " was successfully added to the database!");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
		return new Envelope("Error! The faculty was not added to the database!");
	}
	/**************************ADD NEW COURSE*******************************/
	/**************************ADD NEW FACULTY******************************/
	@RequestMapping(value="/addNewFacultyToDB", method=RequestMethod.POST, produces="application/json")
	public @ResponseBody Envelope insertNewFacultyIntoDB(@RequestParam Map<String, String> params) {
		College college = null;
		Department dept = null;
		User user = null;
		User temp = null;
		...
		try {
			...
			return new Envelope(temp.getLastName() + ", " + temp.getFirstName() + " was successfully added to the database!");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
/********************** DELOADING *************************************/
	...
	public @ResponseBody ArrayList<Faculty> getFacultyListWithKeyViaDeloading(
			@RequestParam("searchKeyword") String searchKeyword,
	...
	public @ResponseBody ArrayList<Deloading> getDeloadingList() {
	...
	public @ResponseBody ArrayList<DeloadOffer> getFacultyDeloading(
			@RequestParam("facultyId") String facultyId,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
			@RequestParam("term") String term)
	...
	public @ResponseBody StringResponse adminDeloading(
			@RequestParam("facultyId") String facultyId,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
			@RequestParam("term") String term,
	...
	public @ResponseBody StringResponse researchDeloading(
			@RequestParam("facultyId") String facultyId,
			@RequestParam("startYear") String startYear,
			@RequestParam("endYear") String endYear,
			@RequestParam("term") String term,
	...
	public @ResponseBody StringResponse removeLoadFromFaculty(
		...
		try {
			deloadoffering = DeloadingDAO.getDeloadOfferingById(deloadofferId, facultyId, startYear, endYear, term);
	...
	public @ResponseBody ArrayList<Faculty> getFacultyListSameDepartment(@RequestParam("departmentId") String departmentId) {
