...
public class LoadDAO {
	public static Load getLoadByFacultyID(String ID) throws SQLException{        
	...
	public static void insertLoad(String facultyID, String offeringId) {
		try {
			Load temp = LoadDAO.getLoadByFacultyID(facultyID);
