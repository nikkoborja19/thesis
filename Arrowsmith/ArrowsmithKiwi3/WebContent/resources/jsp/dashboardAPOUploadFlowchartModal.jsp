      ...
      <div class="modal-body" id="uploadFlowchartModalBody">            
            ...
            <div class="panel-body">
                ...
                <form action="uploadFlowchartFiles" method="POST" enctype="multipart/form-data" id="uploadFlowchartsForm">
                	<input type="file" name="flowchartFiles[]" class="button button-default" multiple/><br><br>
                	<button id="uploadFlowchartsBtn" onclick="fileUpload(this.form, 'uploadFlowchartFiles', 'upload'); return false;" >Upload</button>
                </form>
                <div id="upload">
                </div>
            </div>
